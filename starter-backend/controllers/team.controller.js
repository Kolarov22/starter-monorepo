  ...
  const teams = [
    ...
    },
    {
      ...
      players: [
        ...
        ["Camavinga", "Kroos", "Bellingham"],
        ["Rodrygo", "Vinícius Jr.", "Joselu"],
      ],
    },
    {
      name: "Bayern",
      ...
      players: [
        ["Neuer"],
        ["Mazraoui", "De Ligt", "Kim Min-jae", "Davies"],
    ...
    },
    {
      ...
      players: [
        ["Szczęsny"],
        ["Danilo", "Bremer", "Gatti", "Sandro"],
        ["Locatelli", "Rabiot", "Fagioli"],
        ["Chiesa", "Vlahović", "Yildiz"],
      ],
    },
    {
      name: "Barcelona",
      ...
      players: [
        ...
        ["De Jong", "Gündoğan", "Pedri"],
        ["Yamal", "Lewandowski", "Félix"],
      ],
    },
    {
      name: "City",
      ...
      players: [
        ["Ederson"],
        ["Walker", "Rúben Dias", "Akanji", "Gvardiol"],
        ["Rodri", "De Bruyne", "Bernardo Silva"],
        ["Foden", "Haaland", "Doku"],
      ],
    },
    {
      ...
      players: [
        ...
        ["Loftus-Cheek", "Reijnders", "Bennacer"],
        ["Pulisic", "Leão", "Jović"],
      ],
    },
  ];
